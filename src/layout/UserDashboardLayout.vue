        ...
        <div
            ...
            <header
                ...
                <div class="flex px-12 justify-between items-center">
                    <div>
                        <img class="max-w-[120px]"
                            src="@/assets/img/logo_white.png"alt=""/>
                    </div>
                    <div
                        ...
                        <span class="md:block hidden">neliodossantos15@gmail.com</span>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
            ...
            <div class="flex-1 p-6 mt-[72px] overflow-auto bg-white">
                <div class="flex-1 p-12 overflow-auto bg-white">
                    <slot></slot>
                </div>
            </div>
            <footer class="hidden py-10 px-5 flex flex-col gap-5 text-sm bg-gray-100">
