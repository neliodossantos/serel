...
import CompanyReviewComponent from "@/components/companies/reviews/CompanyReviewComponent.vue";
import ListRelatedCompaniesComponent from "@/components/companies/list/ListRelatedCompaniesComponent.vue";
...
<template>
  ...
  <MainLayout v-else>
      ...
      <div class="w-full mt-10 md:mt-20 min-h-auto px-[12%]">
        <div class="flex lg:gap-16 justify-between items-center flex-wrap gap-4 xs:gap-2">
          ...
          <div class="w-full xs:max-w-72 sm:max-w-md rounded md:w-auto">
            <a :href="`/company/${company.id}/review`" class="max-w-full text-center block lg:inline bg-[#003F72] py-[12px] md:py-[18px] md:px-[45px] rounded text-white border-none">Avaliar empresa</a>
          </div>
        </div>
    ...
    <CompanyReviewComponent :currentCompany="company"></CompanyReviewComponent>
