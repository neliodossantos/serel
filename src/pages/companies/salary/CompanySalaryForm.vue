...
import FormCompanySalary from "@/components/companies/salary/FormCompanySalaryComponent.vue";
    ...
    <MainLayout v-else>
      ...
      <div class=" w-full mb-24 px-[12%]">
        <div class="mx-auto relative max-w-[400px] sm:max-w-[600px] md:max-w-[900px]">
          ...
          <FormCompanySalary @toggleSuccessRequest="toggleSuccessRequest" :currentCompany="company"></FormCompanySalary>
        </div>
      </div>
    </MainLayout>
  </div>
