        ...
        <div class="xs:my-5 my-10">
          <div class="">
            <ul class="md:border-b md:border-gray-300 flex gap-3">
              ...
              <li class="list-none pb-1"><a :href="'/reviews/company/' + company.id" class="cursor-pointer text-[#003F72] text-md  py-3 font-bold">Avaliações</a></li>
              <li class="list-none pb-1 border-b-[4px] border-[#003F72]"><a :href="'/salaries/company/' + company.id" class="cursor-pointer text-[#003F72] text-md  py-3 font-bold">Salários</a></li>
            </ul>
          </div>
        </div>
